...
class UpdateProjectTest extends TestCase
{
    ...
    public function test_update_project_when_unauthenticated()
    {
        $user = User::factory()->createOne();
        $project = Project::factory()->createOne();
        $name = fake()->name();
    ...
    public function test_update_another_user_project()
    {
        $user = User::factory()->createOne();
    ...
    public function test_update_user_project_which_is_not_in_the_database()
    {
        $user = User::factory()->createOne();
    ...
    public function test_update_project_when_name_is_null(){
        $user = User::factory()->createOne();
        $project = Project::factory()->createOne();
        ProjectUser::create([
            'rule' => ProjectUser::RULE_OWNER,
